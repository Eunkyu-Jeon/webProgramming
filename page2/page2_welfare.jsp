...
if (userId==null) {%>
	...
	<ul class="ul2">
	        ...
	        <li><button class="btn42" type="button" onclick="location.href='../main/main.jsp'">로그인</button></li>
	    </ul>
	</div>
	<%
...
<tbody>
                ...
                list1=bbsDAO.getListy(pn,locat);
            ...
            <% if (pageNumber!=1) {
            	%>
            	<center>
            	<a href="page2_welfare.jsp?pageNumber=<%=pageNumber-1%>">이전</a>
            	</center>
            	<%
            }
            	if (bbsDAO.nextPage(pageNumber+1,locat,"요양시설")) {
            		%>
            	<center>
            	<a href="page2_welfare.jsp?pageNumber=<%=pageNumber+1 %>">다음</a>
            	</center>
            <% }%>
