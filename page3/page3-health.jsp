...
if (usrId==null) {%>
	...
	<ul class="ul2">
	        ...
	        <li class="n"><button class="btn2" type="button" onclick="location.href='../page4/notice_read.jsp'">공지사항</button></li>
	        <li class="n"><button class="btn2" type="button" onclick="location.href='../community/community.jsp'">커뮤니티</button></li>
	        <li class="n"><button class="btn41" type="button" onclick="location.href='../member/join.jsp'">회원가입</button></li>
	        <li class="n"><button class="btn42" type="button" onclick="location.href='../main/main.jsp'">로그인</button></li>
	    </ul>
	</div>
	<%
...
<div class="a" id="medic" visiblility="none">
