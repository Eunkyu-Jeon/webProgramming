...
ndao bbs=new notDAO().showPage(id,"b");
%>
...
<div class="board">
	...
	<% if(userId=="admin") {
			%>
		<div class="writebtn">
			<button type="button" onclick="location.href='welfarenotice_modify.jsp?id=<%=id%>'">수정</button>
			<button type="button" onclick="location.href='welfarenotice-delete-db.jsp?id=<%=id%>'">삭제</button>
		</div>
		<%
		} else {
